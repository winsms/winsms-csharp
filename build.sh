...
${nuget_cmd} install src/winsms/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/winsms.dll"
...
then
  ...
  echo "[INFO] bin/winsms.dll was created successfully"
fi
