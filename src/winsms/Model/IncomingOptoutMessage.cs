...
namespace winsms.Model
{
    ...
    public partial class IncomingOptoutMessage :  IEquatable<IncomingOptoutMessage>, IValidatableObject
    {
        ...
        public IncomingOptoutMessage(decimal? incomingApiMessageId = default(decimal?), string mobileNumber = default(string), int? receiveTime = default(int?), string messageText = default(string))
        {
