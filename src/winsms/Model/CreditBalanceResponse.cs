...
namespace winsms.Model
{
    ...
    public partial class CreditBalanceResponse :  IEquatable<CreditBalanceResponse>, IValidatableObject
    {
        ...
        /// <param name="creditBalance">The current remaining credit balance for the account. Contains a single decimal place.</param>
        public CreditBalanceResponse(string timeStamp = default(string), string version = default(string), int? statusCode = default(int?), double? creditBalance = default(double?))
        {
        ...
        /// </summary>
        /// <value>The current remaining credit balance for the account. Contains a single decimal place</value>
