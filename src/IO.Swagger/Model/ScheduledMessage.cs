...
namespace IO.Swagger.Model
{
    ...
    public partial class ScheduledMessage :  IEquatable<ScheduledMessage>, IValidatableObject
    {
        ...
        public ScheduledMessage(int? apiMessageId = default(int?), string mobileNumber = default(string), int? submitTime = default(int?), string scheduledSendTime = default(string), double? creditCost = default(double?))
        {
