...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubAccountsResponse :  IEquatable<SubAccountsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="subAccounts">An array of ***subAccount*** objects containing properties of each Sub Account owned by the Main Account. .</param>
        public SubAccountsResponse(string timeStamp = default(string), string version = default(string), int? statusCode = default(int?), List<SubAccount> subAccounts = default(List<SubAccount>))
        {
        ...
        /// </summary>
        /// <value>An array of ***subAccount*** objects containing properties of each Sub Account owned by the Main Account. </value>
