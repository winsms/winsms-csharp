...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IncomingMessageResponse :  IEquatable<IncomingMessageResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="incomingMessages">An array of ***incomingMessage*** objects containing properties of each incoming message. .</param>
        public IncomingMessageResponse(string timeStamp = default(string), string version = default(string), int? statusCode = default(int?), int? resultsOffset = default(int?), int? resultsLimit = default(int?), int? resultsTotalAvailable = default(int?), List<IncomingMessage> incomingMessages = default(List<IncomingMessage>))
        {
        ...
        /// </summary>
        /// <value>An array of ***incomingMessage*** objects containing properties of each incoming message. </value>
        [DataMember(Name="incomingMessages", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IncomingMessages: ").Append(IncomingMessages).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as IncomingMessageResponse);
        }

        /// <summary>
        /// Returns true if IncomingMessageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IncomingMessageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomingMessageResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IncomingMessages == input.IncomingMessages ||
                    this.IncomingMessages != null &&
                    this.IncomingMessages.SequenceEqual(input.IncomingMessages)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IncomingMessages != null)
                    hashCode = hashCode * 59 + this.IncomingMessages.GetHashCode();
                return hashCode;
            }
        }
